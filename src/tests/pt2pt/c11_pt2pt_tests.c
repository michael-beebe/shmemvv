...
bool test_c11_shmem_wait_until(void) {
  bool result = true;
  result &= TEST_C11_SHMEM_WAIT_UNTIL(short, short);
  ...
  result &= TEST_C11_SHMEM_WAIT_UNTIL(unsigned short, ushort);
...
bool test_c11_shmem_wait_until_all(void) {
  bool result = true;
  result &= TEST_C11_SHMEM_WAIT_UNTIL_ALL(short, short);
  result &= TEST_C11_SHMEM_WAIT_UNTIL_ALL(int, int);
  result &= TEST_C11_SHMEM_WAIT_UNTIL_ALL(long, long);
  result &= TEST_C11_SHMEM_WAIT_UNTIL_ALL(long long, longlong);
  result &= TEST_C11_SHMEM_WAIT_UNTIL_ALL(unsigned short, ushort);
  result &= TEST_C11_SHMEM_WAIT_UNTIL_ALL(unsigned int, uint);
  result &= TEST_C11_SHMEM_WAIT_UNTIL_ALL(unsigned long, ulong);
  result &= TEST_C11_SHMEM_WAIT_UNTIL_ALL(unsigned long long, ulonglong);
  result &= TEST_C11_SHMEM_WAIT_UNTIL_ALL(int32_t, int32);
  result &= TEST_C11_SHMEM_WAIT_UNTIL_ALL(int64_t, int64);
  result &= TEST_C11_SHMEM_WAIT_UNTIL_ALL(uint32_t, uint32);
  result &= TEST_C11_SHMEM_WAIT_UNTIL_ALL(uint64_t, uint64);
  result &= TEST_C11_SHMEM_WAIT_UNTIL_ALL(size_t, size);
  result &= TEST_C11_SHMEM_WAIT_UNTIL_ALL(ptrdiff_t, ptrdiff);
  return result;
}
...
bool test_c11_shmem_wait_until_any(void) {
  bool result = true;
  result &= TEST_C11_SHMEM_WAIT_UNTIL_ANY(short, short);
  result &= TEST_C11_SHMEM_WAIT_UNTIL_ANY(int, int);
  result &= TEST_C11_SHMEM_WAIT_UNTIL_ANY(long, long);
  result &= TEST_C11_SHMEM_WAIT_UNTIL_ANY(long long, longlong);
  result &= TEST_C11_SHMEM_WAIT_UNTIL_ANY(unsigned short, ushort);
  result &= TEST_C11_SHMEM_WAIT_UNTIL_ANY(unsigned int, uint);
  result &= TEST_C11_SHMEM_WAIT_UNTIL_ANY(unsigned long, ulong);
  result &= TEST_C11_SHMEM_WAIT_UNTIL_ANY(unsigned long long, ulonglong);
  result &= TEST_C11_SHMEM_WAIT_UNTIL_ANY(int32_t, int32);
  result &= TEST_C11_SHMEM_WAIT_UNTIL_ANY(int64_t, int64);
  result &= TEST_C11_SHMEM_WAIT_UNTIL_ANY(uint32_t, uint32);
  result &= TEST_C11_SHMEM_WAIT_UNTIL_ANY(uint64_t, uint64);
  result &= TEST_C11_SHMEM_WAIT_UNTIL_ANY(size_t, size);
  result &= TEST_C11_SHMEM_WAIT_UNTIL_ANY(ptrdiff_t, ptrdiff);
  return result;
}
...
bool test_c11_shmem_wait_until_some(void) {
  bool result = true;
  result &= TEST_C11_SHMEM_WAIT_UNTIL_SOME(short, short);
  ...
  result &= TEST_C11_SHMEM_WAIT_UNTIL_SOME(unsigned short, ushort);
...
bool test_c11_shmem_wait_until_any_vector(void) {
  bool result = true;
  result &= TEST_C11_SHMEM_WAIT_UNTIL_ANY_VECTOR(short, short);
  result &= TEST_C11_SHMEM_WAIT_UNTIL_ANY_VECTOR(int, int);
  result &= TEST_C11_SHMEM_WAIT_UNTIL_ANY_VECTOR(long, long);
  result &= TEST_C11_SHMEM_WAIT_UNTIL_ANY_VECTOR(long long, longlong);
  result &= TEST_C11_SHMEM_WAIT_UNTIL_ANY_VECTOR(unsigned short, ushort);
  result &= TEST_C11_SHMEM_WAIT_UNTIL_ANY_VECTOR(unsigned int, uint);
  result &= TEST_C11_SHMEM_WAIT_UNTIL_ANY_VECTOR(unsigned long, ulong);
  result &= TEST_C11_SHMEM_WAIT_UNTIL_ANY_VECTOR(unsigned long long, ulonglong);
  result &= TEST_C11_SHMEM_WAIT_UNTIL_ANY_VECTOR(int32_t, int32);
  result &= TEST_C11_SHMEM_WAIT_UNTIL_ANY_VECTOR(int64_t, int64);
  result &= TEST_C11_SHMEM_WAIT_UNTIL_ANY_VECTOR(uint32_t, uint32);
  result &= TEST_C11_SHMEM_WAIT_UNTIL_ANY_VECTOR(uint64_t, uint64);
  result &= TEST_C11_SHMEM_WAIT_UNTIL_ANY_VECTOR(size_t, size);
  result &= TEST_C11_SHMEM_WAIT_UNTIL_ANY_VECTOR(ptrdiff_t, ptrdiff);
  return result;
}
...
bool test_c11_shmem_test(void) {
  bool result = true;
  result &= TEST_C11_SHMEM_TEST(short, short);
  result &= TEST_C11_SHMEM_TEST(int, int);
  result &= TEST_C11_SHMEM_TEST(long, long);
  result &= TEST_C11_SHMEM_TEST(long long, longlong);
  result &= TEST_C11_SHMEM_TEST(unsigned short, ushort);
  result &= TEST_C11_SHMEM_TEST(unsigned int, uint);
  result &= TEST_C11_SHMEM_TEST(unsigned long, ulong);
  result &= TEST_C11_SHMEM_TEST(unsigned long long, ulonglong);
  result &= TEST_C11_SHMEM_TEST(int32_t, int32);
  result &= TEST_C11_SHMEM_TEST(int64_t, int64);
  result &= TEST_C11_SHMEM_TEST(uint32_t, uint32);
  result &= TEST_C11_SHMEM_TEST(uint64_t, uint64);
  result &= TEST_C11_SHMEM_TEST(size_t, size);
  result &= TEST_C11_SHMEM_TEST(ptrdiff_t, ptrdiff);
  return result;
}
...
bool test_c11_shmem_test_any(void) {
  bool result = true;
  result &= TEST_C11_SHMEM_TEST_ANY(short, short);
  result &= TEST_C11_SHMEM_TEST_ANY(int, int);
  result &= TEST_C11_SHMEM_TEST_ANY(long, long);
  result &= TEST_C11_SHMEM_TEST_ANY(long long, longlong);
  result &= TEST_C11_SHMEM_TEST_ANY(unsigned short, ushort);
  result &= TEST_C11_SHMEM_TEST_ANY(unsigned int, uint);
  result &= TEST_C11_SHMEM_TEST_ANY(unsigned long, ulong);
  result &= TEST_C11_SHMEM_TEST_ANY(unsigned long long, ulonglong);
  result &= TEST_C11_SHMEM_TEST_ANY(int32_t, int32);
  result &= TEST_C11_SHMEM_TEST_ANY(int64_t, int64);
  result &= TEST_C11_SHMEM_TEST_ANY(uint32_t, uint32);
  result &= TEST_C11_SHMEM_TEST_ANY(uint64_t, uint64);
  result &= TEST_C11_SHMEM_TEST_ANY(size_t, size);
  result &= TEST_C11_SHMEM_TEST_ANY(ptrdiff_t, ptrdiff);
  return result;
}
...
bool test_c11_shmem_test_any_vector(void) {
  bool result = true;
  result &= TEST_C11_SHMEM_TEST_ANY_VECTOR(short, short);
  result &= TEST_C11_SHMEM_TEST_ANY_VECTOR(int, int);
  result &= TEST_C11_SHMEM_TEST_ANY_VECTOR(long, long);
  result &= TEST_C11_SHMEM_TEST_ANY_VECTOR(long long, longlong);
  result &= TEST_C11_SHMEM_TEST_ANY_VECTOR(unsigned short, ushort);
  result &= TEST_C11_SHMEM_TEST_ANY_VECTOR(unsigned int, uint);
  result &= TEST_C11_SHMEM_TEST_ANY_VECTOR(unsigned long, ulong);
  result &= TEST_C11_SHMEM_TEST_ANY_VECTOR(unsigned long long, ulonglong);
  result &= TEST_C11_SHMEM_TEST_ANY_VECTOR(int32_t, int32);
  result &= TEST_C11_SHMEM_TEST_ANY_VECTOR(int64_t, int64);
  result &= TEST_C11_SHMEM_TEST_ANY_VECTOR(uint32_t, uint32);
  result &= TEST_C11_SHMEM_TEST_ANY_VECTOR(uint64_t, uint64);
  result &= TEST_C11_SHMEM_TEST_ANY_VECTOR(size_t, size);
  result &= TEST_C11_SHMEM_TEST_ANY_VECTOR(ptrdiff_t, ptrdiff);
  return result;
}
 ...
 */
/****************************************************************/
#define TEST_C11_SHMEM_TEST_SOME_VECTOR(TYPE, TYPENAME)                        \
  ({                                                                           \
    bool success = true;                                                       \
    TYPE *flags = (TYPE *)shmem_malloc(4 * sizeof(TYPE));                      \
    if (flags == NULL) {                                                       \
...
bool test_c11_shmem_test_some_vector(void) {
  bool result = true;
  result &= TEST_C11_SHMEM_TEST_SOME_VECTOR(short, short);
  result &= TEST_C11_SHMEM_TEST_SOME_VECTOR(int, int);
  result &= TEST_C11_SHMEM_TEST_SOME_VECTOR(long, long);
  result &= TEST_C11_SHMEM_TEST_SOME_VECTOR(long long, longlong);
  result &= TEST_C11_SHMEM_TEST_SOME_VECTOR(unsigned short, ushort);
  result &= TEST_C11_SHMEM_TEST_SOME_VECTOR(unsigned int, uint);
  result &= TEST_C11_SHMEM_TEST_SOME_VECTOR(unsigned long, ulong);
  result &= TEST_C11_SHMEM_TEST_SOME_VECTOR(unsigned long long, ulonglong);
  result &= TEST_C11_SHMEM_TEST_SOME_VECTOR(int32_t, int32);
  result &= TEST_C11_SHMEM_TEST_SOME_VECTOR(int64_t, int64);
  result &= TEST_C11_SHMEM_TEST_SOME_VECTOR(uint32_t, uint32);
  result &= TEST_C11_SHMEM_TEST_SOME_VECTOR(uint64_t, uint64);
  result &= TEST_C11_SHMEM_TEST_SOME_VECTOR(size_t, size);
  result &= TEST_C11_SHMEM_TEST_SOME_VECTOR(ptrdiff_t, ptrdiff);
  return result;
}
...
bool test_c11_shmem_signal_wait_until(void) {
  return TEST_C11_SHMEM_SIGNAL_WAIT_UNTIL();
}
