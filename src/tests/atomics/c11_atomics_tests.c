...
bool test_c11_shmem_atomic_compare_swap_nbi(void) {
  ...
  result &=
      TEST_C11_SHMEM_ATOMIC_COMPARE_SWAP_NBI(unsigned long long, ulonglong);
...
void run_c11_atomics_tests(int mype, int npes) {
  ...
  if (!(npes > 1)) {
    ...
    shmem_barrier_all();
    if (mype == 0) {
      display_test_result("C11 shmem_atomic_xor()", result_shmem_atomic_xor,
                          false);
    }
    ...
    shmem_barrier_all();
    if (mype == 0) {
      display_test_result("C11 shmem_atomic_fetch_nbi()",
    ...
    bool result_shmem_atomic_compare_swap_nbi =
        test_c11_shmem_atomic_compare_swap_nbi();
    shmem_barrier_all();
    if (mype == 0) {
      display_test_result("C11 shmem_atomic_compare_swap_nbi()",
    ...
    shmem_barrier_all();
    if (mype == 0) {
      display_test_result("C11 shmem_atomic_swap_nbi()",
    ...
    bool result_shmem_atomic_fetch_inc_nbi =
        test_c11_shmem_atomic_fetch_inc_nbi();
    shmem_barrier_all();
    if (mype == 0) {
      display_test_result("C11 shmem_atomic_fetch_inc_nbi()",
    ...
    bool result_shmem_atomic_fetch_add_nbi =
        test_c11_shmem_atomic_fetch_add_nbi();
    shmem_barrier_all();
    if (mype == 0) {
      display_test_result("C11 shmem_atomic_fetch_add_nbi()",
    ...
    bool result_shmem_atomic_fetch_and_nbi =
        test_c11_shmem_atomic_fetch_and_nbi();
    shmem_barrier_all();
    if (mype == 0) {
      display_test_result("C11 shmem_atomic_fetch_and_nbi()",
    ...
    bool result_shmem_atomic_fetch_or_nbi =
        test_c11_shmem_atomic_fetch_or_nbi();
    shmem_barrier_all();
    if (mype == 0) {
      display_test_result("C11 shmem_atomic_fetch_or_nbi()",
    ...
    bool result_shmem_atomic_fetch_xor_nbi =
        test_c11_shmem_atomic_fetch_xor_nbi();
    shmem_barrier_all();
    if (mype == 0) {
      display_test_result("C11 shmem_atomic_fetch_xor_nbi()",
