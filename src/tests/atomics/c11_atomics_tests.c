...
#define TEST_C11_SHMEM_ATOMIC_COMPARE_SWAP(TYPE, TYPENAME) \
  ({                                                       \
    ...
    *dest = old;                                           \
    ...
    shmem_barrier_all();                                   \
    TYPE swapped = shmem_atomic_compare_swap(dest, old, new_val, (mype + 1) % npes); \
    shmem_barrier_all();                                   \
 ...
 *
 * This test verifies that the shmem_atomic_fetch_nbi() routine
 * correctly retrieves the value from a remote memory location
 ...
 */
/****************************************************************/
#define TEST_C11_SHMEM_ATOMIC_FETCH_NBI(TYPE, TYPENAME) \
  ({                                                    \
    bool success = true;                                \
    static TYPE *dest;                                  \
    static TYPE fetch;                                  \
...
bool test_c11_shmem_atomic_fetch_nbi(void) {
  bool result = true;
  // result &= TEST_C11_SHMEM_ATOMIC_FETCH_NBI(int, int);
  // result &= TEST_C11_SHMEM_ATOMIC_FETCH_NBI(long, long);
  // result &= TEST_C11_SHMEM_ATOMIC_FETCH_NBI(long long, longlong);
  result &= TEST_C11_SHMEM_ATOMIC_FETCH_NBI(unsigned int, uint);
  result &= TEST_C11_SHMEM_ATOMIC_FETCH_NBI(unsigned long, ulong);
  result &= TEST_C11_SHMEM_ATOMIC_FETCH_NBI(unsigned long long, ulonglong);
  result &= TEST_C11_SHMEM_ATOMIC_FETCH_NBI(int32_t, int32);
  result &= TEST_C11_SHMEM_ATOMIC_FETCH_NBI(int64_t, int64);
  result &= TEST_C11_SHMEM_ATOMIC_FETCH_NBI(uint32_t, uint32);
  result &= TEST_C11_SHMEM_ATOMIC_FETCH_NBI(uint64_t, uint64);
  // result &= TEST_C11_SHMEM_ATOMIC_FETCH_NBI(size_t, size);
  // result &= TEST_C11_SHMEM_ATOMIC_FETCH_NBI(ptrdiff_t, ptrdiff);
  return result;
}
 ...
 * routine correctly swaps the value at a remote memory
 * location in a non-blocking manner if it matches the expected value.
 *
 * @return True if the test is successful, false otherwise.
 */
/****************************************************************/
#define TEST_C11_SHMEM_ATOMIC_COMPARE_SWAP_NBI(TYPE, TYPENAME) \
  ({                                                          \
    bool success = true;                                      \
    static TYPE *dest;                                        \
    static TYPE fetch;                                        \
...
bool test_c11_shmem_atomic_compare_swap_nbi(void) {
  bool result = true;
  // result &= TEST_C11_SHMEM_ATOMIC_COMPARE_SWAP_NBI(int, int);
  // result &= TEST_C11_SHMEM_ATOMIC_COMPARE_SWAP_NBI(long, long);
  // result &= TEST_C11_SHMEM_ATOMIC_COMPARE_SWAP_NBI(long long, longlong);
  result &= TEST_C11_SHMEM_ATOMIC_COMPARE_SWAP_NBI(unsigned int, uint);
  result &= TEST_C11_SHMEM_ATOMIC_COMPARE_SWAP_NBI(unsigned long, ulong);
  result &= TEST_C11_SHMEM_ATOMIC_COMPARE_SWAP_NBI(unsigned long long, ulonglong);
  result &= TEST_C11_SHMEM_ATOMIC_COMPARE_SWAP_NBI(int32_t, int32);
  result &= TEST_C11_SHMEM_ATOMIC_COMPARE_SWAP_NBI(int64_t, int64);
  result &= TEST_C11_SHMEM_ATOMIC_COMPARE_SWAP_NBI(uint32_t, uint32);
  result &= TEST_C11_SHMEM_ATOMIC_COMPARE_SWAP_NBI(uint64_t, uint64);
  // result &= TEST_C11_SHMEM_ATOMIC_COMPARE_SWAP_NBI(size_t, size);
  // result &= TEST_C11_SHMEM_ATOMIC_COMPARE_SWAP_NBI(ptrdiff_t, ptrdiff);
  return result;
}
 ...
 */
/****************************************************************/
#define TEST_C11_SHMEM_ATOMIC_SWAP_NBI(TYPE, TYPENAME)  \
  ({                                                    \
    bool success = true;                                \
    static TYPE *dest;                                  \
    static TYPE fetch;                                  \
...
bool test_c11_shmem_atomic_swap_nbi(void) {
  bool result = true;
  // result &= TEST_C11_SHMEM_ATOMIC_SWAP_NBI(int, int);
  // result &= TEST_C11_SHMEM_ATOMIC_SWAP_NBI(long, long);
  // result &= TEST_C11_SHMEM_ATOMIC_SWAP_NBI(long long, longlong);
  result &= TEST_C11_SHMEM_ATOMIC_SWAP_NBI(unsigned int, uint);
  result &= TEST_C11_SHMEM_ATOMIC_SWAP_NBI(unsigned long, ulong);
  result &= TEST_C11_SHMEM_ATOMIC_SWAP_NBI(unsigned long long, ulonglong);
  result &= TEST_C11_SHMEM_ATOMIC_SWAP_NBI(int32_t, int32);
  result &= TEST_C11_SHMEM_ATOMIC_SWAP_NBI(int64_t, int64);
  result &= TEST_C11_SHMEM_ATOMIC_SWAP_NBI(uint32_t, uint32);
  result &= TEST_C11_SHMEM_ATOMIC_SWAP_NBI(uint64_t, uint64);
  // result &= TEST_C11_SHMEM_ATOMIC_SWAP_NBI(size_t, size);
  // result &= TEST_C11_SHMEM_ATOMIC_SWAP_NBI(ptrdiff_t, ptrdiff);
  return result;
}
 ...
 */
/****************************************************************/
#define TEST_C11_SHMEM_ATOMIC_FETCH_INC_NBI(TYPE, TYPENAME) \
  ({                                                        \
    bool success = true;                                    \
    static TYPE *dest;                                      \
    static TYPE fetch;                                      \
...
bool test_c11_shmem_atomic_fetch_inc_nbi(void) {
  bool result = true;
  // result &= TEST_C11_SHMEM_ATOMIC_FETCH_INC_NBI(int, int);
  // result &= TEST_C11_SHMEM_ATOMIC_FETCH_INC_NBI(long, long);
  // result &= TEST_C11_SHMEM_ATOMIC_FETCH_INC_NBI(long long, longlong);
  result &= TEST_C11_SHMEM_ATOMIC_FETCH_INC_NBI(unsigned int, uint);
  result &= TEST_C11_SHMEM_ATOMIC_FETCH_INC_NBI(unsigned long, ulong);
  result &= TEST_C11_SHMEM_ATOMIC_FETCH_INC_NBI(unsigned long long, ulonglong);
  result &= TEST_C11_SHMEM_ATOMIC_FETCH_INC_NBI(int32_t, int32);
  result &= TEST_C11_SHMEM_ATOMIC_FETCH_INC_NBI(int64_t, int64);
  result &= TEST_C11_SHMEM_ATOMIC_FETCH_INC_NBI(uint32_t, uint32);
  result &= TEST_C11_SHMEM_ATOMIC_FETCH_INC_NBI(uint64_t, uint64);
  // result &= TEST_C11_SHMEM_ATOMIC_FETCH_INC_NBI(size_t, size);
  // result &= TEST_C11_SHMEM_ATOMIC_FETCH_INC_NBI(ptrdiff_t, ptrdiff);
  return result;
}
 ...
 */
/****************************************************************/
#define TEST_C11_SHMEM_ATOMIC_FETCH_ADD_NBI(TYPE, TYPENAME)   \
  ({                                                          \
    bool success = true;                                      \
    static TYPE *dest;                                        \
    static TYPE fetch;                                        \
...
bool test_c11_shmem_atomic_fetch_add_nbi(void) {
  bool result = true;
  // result &= TEST_C11_SHMEM_ATOMIC_FETCH_ADD_NBI(int, int);
  // result &= TEST_C11_SHMEM_ATOMIC_FETCH_ADD_NBI(long, long);
  // result &= TEST_C11_SHMEM_ATOMIC_FETCH_ADD_NBI(long long, longlong);
  result &= TEST_C11_SHMEM_ATOMIC_FETCH_ADD_NBI(unsigned int, uint);
  result &= TEST_C11_SHMEM_ATOMIC_FETCH_ADD_NBI(unsigned long, ulong);
  result &= TEST_C11_SHMEM_ATOMIC_FETCH_ADD_NBI(unsigned long long, ulonglong);
  result &= TEST_C11_SHMEM_ATOMIC_FETCH_ADD_NBI(int32_t, int32);
  result &= TEST_C11_SHMEM_ATOMIC_FETCH_ADD_NBI(int64_t, int64);
  result &= TEST_C11_SHMEM_ATOMIC_FETCH_ADD_NBI(uint32_t, uint32);
  result &= TEST_C11_SHMEM_ATOMIC_FETCH_ADD_NBI(uint64_t, uint64);
  // result &= TEST_C11_SHMEM_ATOMIC_FETCH_ADD_NBI(size_t, size);
  // result &= TEST_C11_SHMEM_ATOMIC_FETCH_ADD_NBI(ptrdiff_t, ptrdiff);
  return result;
}
 ...
 * routine correctly performs a bitwise AND operation with
 * the remote memory location in a non-blocking manner and returns
 * the old value.
 *
 * @return True if the test is successful, false otherwise.
 */
/****************************************************************/
#define TEST_C11_SHMEM_ATOMIC_FETCH_AND_NBI(TYPE, TYPENAME)   \
  ({                                                          \
    bool success = true;                                      \
    static TYPE *dest;                                        \
    static TYPE fetch;                                        \
...
bool test_c11_shmem_atomic_fetch_and_nbi(void) {
  bool result = true;
  // result &= TEST_C11_SHMEM_ATOMIC_FETCH_AND_NBI(int, int);
  // result &= TEST_C11_SHMEM_ATOMIC_FETCH_AND_NBI(long, long);
  // result &= TEST_C11_SHMEM_ATOMIC_FETCH_AND_NBI(long long, longlong);
  result &= TEST_C11_SHMEM_ATOMIC_FETCH_AND_NBI(unsigned int, uint);
  result &= TEST_C11_SHMEM_ATOMIC_FETCH_AND_NBI(unsigned long, ulong);
  result &= TEST_C11_SHMEM_ATOMIC_FETCH_AND_NBI(unsigned long long, ulonglong);
  result &= TEST_C11_SHMEM_ATOMIC_FETCH_AND_NBI(int32_t, int32);
  result &= TEST_C11_SHMEM_ATOMIC_FETCH_AND_NBI(int64_t, int64);
  result &= TEST_C11_SHMEM_ATOMIC_FETCH_AND_NBI(uint32_t, uint32);
  result &= TEST_C11_SHMEM_ATOMIC_FETCH_AND_NBI(uint64_t, uint64);
  // result &= TEST_C11_SHMEM_ATOMIC_FETCH_AND_NBI(size_t, size);
  // result &= TEST_C11_SHMEM_ATOMIC_FETCH_AND_NBI(ptrdiff_t, ptrdiff);
  return result;
}
 ...
 */
/****************************************************************/
#define TEST_C11_SHMEM_ATOMIC_FETCH_OR_NBI(TYPE, TYPENAME)    \
  ({                                                          \
    bool success = true;                                      \
    static TYPE *dest;                                        \
    static TYPE fetch;                                        \
...
bool test_c11_shmem_atomic_fetch_or_nbi(void) {
  bool result = true;
  // result &= TEST_C11_SHMEM_ATOMIC_FETCH_OR_NBI(int, int);
  // result &= TEST_C11_SHMEM_ATOMIC_FETCH_OR_NBI(long, long);
  // result &= TEST_C11_SHMEM_ATOMIC_FETCH_OR_NBI(long long, longlong);
  result &= TEST_C11_SHMEM_ATOMIC_FETCH_OR_NBI(unsigned int, uint);
  result &= TEST_C11_SHMEM_ATOMIC_FETCH_OR_NBI(unsigned long, ulong);
  result &= TEST_C11_SHMEM_ATOMIC_FETCH_OR_NBI(unsigned long long, ulonglong);
  result &= TEST_C11_SHMEM_ATOMIC_FETCH_OR_NBI(int32_t, int32);
  result &= TEST_C11_SHMEM_ATOMIC_FETCH_OR_NBI(int64_t, int64);
  result &= TEST_C11_SHMEM_ATOMIC_FETCH_OR_NBI(uint32_t, uint32);
  result &= TEST_C11_SHMEM_ATOMIC_FETCH_OR_NBI(uint64_t, uint64);
  // result &= TEST_C11_SHMEM_ATOMIC_FETCH_OR_NBI(size_t, size);
  // result &= TEST_C11_SHMEM_ATOMIC_FETCH_OR_NBI(ptrdiff_t, ptrdiff);
  return result;
}
 ...
 * remote memory location in a non-blocking manner and returns the old value.
 *
 * @return True if the test is successful, false otherwise.
 */
/****************************************************************/
#define TEST_C11_SHMEM_ATOMIC_FETCH_XOR_NBI(TYPE, TYPENAME)   \
  ({                                                          \
    bool success = true;                                      \
    static TYPE *dest;                                        \
    static TYPE fetch;                                        \
...
bool test_c11_shmem_atomic_fetch_xor_nbi(void) {
  bool result = true;
  // result &= TEST_C11_SHMEM_ATOMIC_FETCH_XOR_NBI(int, int);
  // result &= TEST_C11_SHMEM_ATOMIC_FETCH_XOR_NBI(long, long);
  // result &= TEST_C11_SHMEM_ATOMIC_FETCH_XOR_NBI(long long, longlong);
  result &= TEST_C11_SHMEM_ATOMIC_FETCH_XOR_NBI(unsigned int, uint);
  result &= TEST_C11_SHMEM_ATOMIC_FETCH_XOR_NBI(unsigned long, ulong);
  result &= TEST_C11_SHMEM_ATOMIC_FETCH_XOR_NBI(unsigned long long, ulonglong);
  result &= TEST_C11_SHMEM_ATOMIC_FETCH_XOR_NBI(int32_t, int32);
  result &= TEST_C11_SHMEM_ATOMIC_FETCH_XOR_NBI(int64_t, int64);
  result &= TEST_C11_SHMEM_ATOMIC_FETCH_XOR_NBI(uint32_t, uint32);
  result &= TEST_C11_SHMEM_ATOMIC_FETCH_XOR_NBI(uint64_t, uint64);
  // result &= TEST_C11_SHMEM_ATOMIC_FETCH_XOR_NBI(size_t, size);
  // result &= TEST_C11_SHMEM_ATOMIC_FETCH_XOR_NBI(ptrdiff_t, ptrdiff);
  return result;
}
...
void run_c11_atomics_tests(int mype, int npes) {
  ...
  if (!(npes > 1)) {
    ...
    shmem_barrier_all();
    if (mype == 0) {
      display_test_result("C11 shmem_atomic_fetch()", result_shmem_atomic_fetch, false);
    }
    ...
    shmem_barrier_all();
    if (mype == 0) {
      display_test_result("C11 shmem_atomic_set()", result_shmem_atomic_set, false);
    }

    /* Run shmem_atomic_compare_swap() test */
    shmem_barrier_all();
    bool result_shmem_atomic_compare_swap = test_c11_shmem_atomic_compare_swap();
    shmem_barrier_all();
    if (mype == 0) {
      display_test_result("C11 shmem_atomic_compare_swap()", result_shmem_atomic_compare_swap, false);
    }
    ...
    shmem_barrier_all();
    if (mype == 0) {
      display_test_result("C11 shmem_atomic_swap()", result_shmem_atomic_swap, false);
    }
    ...
    shmem_barrier_all();
    if (mype == 0) {
      display_test_result("C11 shmem_atomic_fetch_inc()", result_shmem_atomic_fetch_inc, false);
    }
    ...
    shmem_barrier_all();
    if (mype == 0) {
      display_test_result("C11 shmem_atomic_inc()", result_shmem_atomic_inc, false);
    }
    ...
    shmem_barrier_all();
    if (mype == 0) {
      display_test_result("C11 shmem_atomic_fetch_add()", result_shmem_atomic_fetch_add, false);
    }
    ...
    shmem_barrier_all();
    if (mype == 0) {
      display_test_result("C11 shmem_atomic_add()", result_shmem_atomic_add, false);
    }
    ...
    shmem_barrier_all();
    if (mype == 0) {
      display_test_result("C11 shmem_atomic_fetch_and()", result_shmem_atomic_fetch_and, false);
    }
    ...
    shmem_barrier_all();
    if (mype == 0) {
      display_test_result("C11 shmem_atomic_and()", result_shmem_atomic_and, false);
    }
    ...
    shmem_barrier_all();
    if (mype == 0) {
      display_test_result("C11 shmem_atomic_fetch_or()", result_shmem_atomic_fetch_or, false);
    }
    ...
    shmem_barrier_all();
    if (mype == 0) {
      display_test_result("C11 shmem_atomic_or()", result_shmem_atomic_or, false);
    }
    ...
    shmem_barrier_all();
    if (mype == 0) {
      display_test_result("C11 shmem_atomic_fetch_xor()", result_shmem_atomic_fetch_xor, false);
    }

    /* Run shmem_atomic_xor() test */
    shmem_barrier_all();
    bool result_shmem_atomic_xor = test_c11_shmem_atomic_xor();
    shmem_barrier_all();
    if (mype == 0) {
      display_test_result("C11 shmem_atomic_xor()", result_shmem_atomic_xor, false);
    }

    /* Run shmem_atomic_fetch_nbi() test */
    shmem_barrier_all();
    bool result_shmem_atomic_fetch_nbi = test_c11_shmem_atomic_fetch_nbi();
    shmem_barrier_all();
    if (mype == 0) {
      display_test_result("C11 shmem_atomic_fetch_nbi()", result_shmem_atomic_fetch_nbi, false);
    }

    /* Run shmem_atomic_compare_swap_nbi() test */
    shmem_barrier_all();
    bool result_shmem_atomic_compare_swap_nbi = test_c11_shmem_atomic_compare_swap_nbi();
    shmem_barrier_all();
    if (mype == 0) {
      display_test_result("C11 shmem_atomic_compare_swap_nbi()", result_shmem_atomic_compare_swap_nbi, false);
    }

    /* Run shmem_atomic_swap_nbi() test */
    shmem_barrier_all();
    bool result_shmem_atomic_swap_nbi = test_c11_shmem_atomic_swap_nbi();
    shmem_barrier_all();
    if (mype == 0) {
      display_test_result("C11 shmem_atomic_swap_nbi()", result_shmem_atomic_swap_nbi, false);
    }

    /* Run shmem_atomic_fetch_inc_nbi() test */
    shmem_barrier_all();
    bool result_shmem_atomic_fetch_inc_nbi = test_c11_shmem_atomic_fetch_inc_nbi();
    shmem_barrier_all();
    if (mype == 0) {
      display_test_result("C11 shmem_atomic_fetch_inc_nbi()", result_shmem_atomic_fetch_inc_nbi, false);
    }

    /* Run shmem_atomic_fetch_add_nbi() test */
    shmem_barrier_all();
    bool result_shmem_atomic_fetch_add_nbi = test_c11_shmem_atomic_fetch_add_nbi();
    shmem_barrier_all();
    if (mype == 0) {
      display_test_result("C11 shmem_atomic_fetch_add_nbi()", result_shmem_atomic_fetch_add_nbi, false);
    }

    /* Run shmem_atomic_fetch_and_nbi() test */
    shmem_barrier_all();
    bool result_shmem_atomic_fetch_and_nbi = test_c11_shmem_atomic_fetch_and_nbi();
    shmem_barrier_all();
    if (mype == 0) {
      display_test_result("C11 shmem_atomic_fetch_and_nbi()", result_shmem_atomic_fetch_and_nbi, false);
    }

    /* Run shmem_atomic_fetch_or_nbi() test */
    shmem_barrier_all();
    bool result_shmem_atomic_fetch_or_nbi = test_c11_shmem_atomic_fetch_or_nbi();
    shmem_barrier_all();
    if (mype == 0) {
      display_test_result("C11 shmem_atomic_fetch_or_nbi()", result_shmem_atomic_fetch_or_nbi, false);
    }

    /* Run shmem_atomic_fetch_xor_nbi() test */
    shmem_barrier_all();
    bool result_shmem_atomic_fetch_xor_nbi = test_c11_shmem_atomic_fetch_xor_nbi();
    shmem_barrier_all();
    if (mype == 0) {
      display_test_result("C11 shmem_atomic_fetch_xor_nbi()", result_shmem_atomic_fetch_xor_nbi, false);
    }
  }
}
