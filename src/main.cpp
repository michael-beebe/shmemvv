  ...
  */
  ...
  if (opts.test_threads) {
    ...
    if ( !check_if_exists("shmem_query_thread") ) {
      ...
      bool result_shmem_query_thread = text_shmem_query_thread();
      shmem_barrier_all();
      if (mype == 0) {
  ...
  if (opts.test_mem) {
    ...
    if ( check_if_exists("shmem_malloc") && check_if_exists("shmem_free") ) {
      bool result_shmem_malloc_free = text_shmem_malloc_free();
      shmem_barrier_all();
      if (mype == 0) {
    ...
    if ( !check_if_exists("shmem_ptr") ) {
      ...
      bool result_shmem_ptr = text_shmem_ptr();
      shmem_barrier_all();
      if (mype == 0) {
    ...
    if ( !check_if_exists("shmem_addr_accessible") ) {
      ...
      bool result_shmem_addr_accessible = text_shmem_addr_accessible();
      shmem_barrier_all();
      if (mype == 0) {
    ...
    if ( !check_if_exists("shmem_realloc") ) {
      ...
      bool result_shmem_realloc = text_shmem_realloc();
      shmem_barrier_all();
      if (mype == 0) {
    ...
    if ( !check_if_exists("shmem_align") ) {
      ...
      bool result_shmem_align = text_shmem_align();
      shmem_barrier_all();
      if (mype == 0) {
    ...
    if ( !check_if_exists("shmem_malloc_with_hints") ) {
      ...
      bool result_shmem_malloc_with_hints = text_shmem_malloc_with_hints();
      shmem_barrier_all();
      if (mype == 0) {
    ...
    if ( !check_if_exists("shmem_calloc") ) {
      ...
      bool result_shmem_calloc = text_shmem_calloc();
      shmem_barrier_all();
      if (mype == 0) {
  ...
  if (opts.test_teams) {
    ...
    if ( !check_if_exists("shmem_team_my_pe") ) {
      ...
      bool result_shmem_team_my_pe = text_shmem_team_my_pe();
      shmem_barrier_all();
      if (mype == 0) {
    ...
    if ( !check_if_exists("shmem_team_n_pes") ) {
      ...
      bool result_shmem_team_n_pes = text_shmem_team_n_pes();
      shmem_barrier_all();
      if (mype == 0) {
    ...
    if ( !check_if_exists("shmem_team_get_config") ) {
      ...
      bool result_shmem_team_get_config = text_shmem_team_get_config();
      shmem_barrier_all();
      if (mype == 0) {
    ...
    if ( !check_if_exists("shmem_team_translate_pe") ) {
      ...
      bool result_shmem_team_translate_pe = text_shmem_team_translate_pe();
      shmem_barrier_all();
      if (mype == 0) {
    ...
    if ( !check_if_exists("shmem_team_split_strided") ) {
      ...
      bool result_shmem_team_split_strided = text_shmem_team_split_strided();
      shmem_barrier_all();
      if (mype == 0) {
    ...
    if ( !check_if_exists("shmem_team_split_2d") ) {
      ...
      bool result_shmem_team_split_2d = text_shmem_team_split_2d();
      shmem_barrier_all();
      if (mype == 0) {
    ...
    if ( !check_if_exists("shmem_team_destroy") ) {
      ...
      bool result_shmem_team_destroy = text_shmem_team_destroy();
      shmem_barrier_all();
      if (mype == 0) {
  ...
  if (opts.test_ctx) {
    ...
    if (!check_if_exists("shmem_ctx_create")) {
      ...
      bool result_shmem_ctx_create = text_shmem_ctx_create();
      shmem_barrier_all();
      if (mype == 0) {
    ...
    if (!check_if_exists("shmem_team_create_ctx")) {
      ...
      bool result_shmem_team_create_ctx = text_shmem_team_create_ctx();
      shmem_barrier_all();
      if (mype == 0) {
    ...
    if (!check_if_exists("shmem_ctx_destroy")) {
      ...
      bool result_shmem_ctx_destroy = text_shmem_ctx_destroy();
      shmem_barrier_all();
      if (mype == 0) {
    ...
    if (!check_if_exists("shmem_ctx_get_team")) {
      ...
      bool result_shmem_ctx_get_team = text_shmem_ctx_get_team();
      shmem_barrier_all();
      if (mype == 0) {
  ...
  if (opts.test_collectives) {
    ...
    if ( !(npes > 1) ) {
      ...
      /* Run shmem_sync() test */ // TODO: should this be shmem_team_sync() for C++?
      shmem_barrier_all();
  ...
  if (opts.test_mem_ordering) {
    ...
    if ( !(npes > 1) ) {
      ...
      if ( !check_if_exists("shmem_fence") ) {
        ...
        bool result_shmem_fence = text_shmem_fence();
        shmem_barrier_all();
        if (mype == 0) {
      ...
      if ( !check_if_exists("shmem_quiet") ) {
        ...
        bool result_shmem_quiet = text_shmem_quiet();
        shmem_barrier_all();
        if (mype == 0) {
  ...
  if (opts.test_locking) {
    ...
    if ( !(npes > 1) ) {
      ...
      if ( check_if_exists("shmem_set_lock") && check_if_exists("shmem_clear_lock") ) {
        bool result_shmem_lock_unlock = text_shmem_lock_unlock();
        shmem_barrier_all();
        if (mype == 0) {
  ...
  if ( !check_if_exists("shmem_finalize") ) {
    ...
    if (mype == 0) {
      ...
      display_test_result("shmem_finalize()", text_shmem_finalize(), false);
      std::cout << std::endl;
    }
  }
